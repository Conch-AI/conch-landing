            ...
            <div className="flex gap-12">
              <div>
                ...
                <div className="flex flex-col gap-2.5">
                  <a href="#" className="text-[13px] text-foreground hover:text-[#8b5cf6] transition-colors">Blog</a>
                  <a href="#" className="text-[13px] text-foreground hover:text-[#8b5cf6] transition-colors">Terms of Service</a>
                  <a href="#" className="text-[13px] text-foreground hover:text-[#8b5cf6] transition-colors">Privacy Policy</a>
                </div>
              </div>
              <div>
                <p className="text-[11px] text-muted-foreground uppercase tracking-wider mb-3.5 font-medium">Support</p>
                <div className="flex flex-col gap-2.5">
                  <a href="#" className="text-[13px] text-foreground hover:text-[#8b5cf6] transition-colors">Contact Us</a>
                  <a href="#" className="text-[13px] text-foreground hover:text-[#8b5cf6] transition-colors">Help Center</a>
                </div>
              </div>
              <div>
                <p className="text-[11px] text-muted-foreground uppercase tracking-wider mb-3.5 font-medium">Tools</p>
                <div className="flex flex-col gap-2.5">
                  <a href="#" className="text-[13px] text-foreground hover:text-[#8b5cf6] transition-colors">Simplify</a>
                  <a href="#" className="text-[13px] text-foreground hover:text-[#8b5cf6] transition-colors">Stealth Mode</a>
                  <a href="#" className="text-[13px] text-foreground hover:text-[#8b5cf6] transition-colors">Flashcards</a>
                  <a href="#" className="text-[13px] text-foreground hover:text-[#8b5cf6] transition-colors">Notes</a>
                </div>
              </div>
            </div>
          </div>
