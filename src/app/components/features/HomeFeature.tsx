    ...
    <div className="min-h-full bg-background text-foreground overflow-y-auto">
      ...
      <footer className="px-4 md:px-6 pt-12 md:pt-20 pb-8 md:pb-10">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex gap-16 md:gap-24">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2.5 md:gap-4">
                  ...
                  <a href="#" className="text-[13px] md:text-base text-foreground hover:text-[#6366f1] transition-colors">Terms of Service</a>
                  <a href="#" className="text-[13px] md:text-base text-foreground hover:text-[#6366f1] transition-colors">Privacy Policy</a>
                </div>
              </div>
              {/* Support */}
              <div>
                ...
                <div className="flex flex-col gap-2.5 md:gap-4">
                  <a href="#" className="text-[13px] md:text-base text-foreground hover:text-[#6366f1] transition-colors">Contact Us</a>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Copyright */}
          <div>
            <p className="text-[12px] md:text-sm text-muted-foreground">Yofi Tech, LLC • Copyright © 2025</p>
          </div>
        </div>
      </footer>
    </div>
